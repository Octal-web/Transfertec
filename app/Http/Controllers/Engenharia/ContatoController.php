...
use App\Http\Requests\Engenharia\PostContactRequest;
...
class ContatoController extends Controller
{
    ...
    public function index() {
        return Inertia::render('Engenharia/Contato');
    }
    ...
    public function enviar(PostContactRequest $request) {
        if($request->post()){
            ...
            if ($response) {
                ...
                Mail::send('emails.eng.contact', $data, function($message)use($data) {
        ...
        return Inertia::location(route('Engenharia.Contato.index'));
    }
};