...
use App\Models\Engenharia\SlideIdioma;
use App\Models\Engenharia\Idioma;

use Illuminate\Http\Request;
use Inertia\Inertia;
use App\Http\Requests\Engenharia\Manager\PostSlideRequest;
...
class SlidesController extends Controller
{
    ...
    public function adicionar($tipo) {
        ...
        return Inertia::render('Engenharia/Manager/Slides/adicionar', [
            'tipo' => $tipo
        ]);
    }
    ...
    public function editar($id) {
        ...
        if ($slide->tipo === 'imagem') {
            $slideData['imagem'] = asset('eng/content/slides/d/' . $slide->imagem);
            $slideData['imagem_mobile'] = asset('eng/content/slides/m/' . $slide->imagem_mobile);
        }
        
        return Inertia::render('Engenharia/Manager/Slides/editar', [
            'idiomas' => $idiomas,
            'idioma' => $idioma,
            'slide' => $slideData
        ]);
    ...
    public function baixarVideo($id, $video) {
        ...
        if ($video == 'desktop') {
            $caminho = public_path('eng/content/slides/videos/d/' . $slide->video);
        } else if ($video == 'mobile') {
            $caminho = public_path('eng/content/slides/videos/m/' . $slide->video_mobile);
        }
