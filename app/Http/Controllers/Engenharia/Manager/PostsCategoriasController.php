...
use App\Models\Engenharia\PostCategoriaIdioma;
use App\Models\Engenharia\Idioma;

use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Inertia\Inertia;
use App\Http\Requests\Engenharia\Manager\PostCategoryRequest;
...
class PostsCategoriasController extends Controller
{
    ...
    public function adicionar() {
        ...
        return Inertia::render('Engenharia/Manager/Posts/Categorias/adicionar');
    }
    ...
    public function editar($id) {
        ...
        return Inertia::render('Engenharia/Manager/Posts/Categorias/editar', [
            'idiomas' => $idiomas,
            'idioma' => $idioma,
            'categoria' => $categoria
        ]);
