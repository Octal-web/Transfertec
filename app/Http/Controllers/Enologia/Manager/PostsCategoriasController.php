...
use App\Models\Enologia\PostCategoriaIdioma;
...
class PostsCategoriasController extends Controller
{
    ...
    public function adicionar() {
        ...
        return Inertia::render('Enologia/Manager/Posts/Categorias/adicionar');
    }
    ...
    public function editar($id) {
        ...
        return Inertia::render('Enologia/Manager/Posts/Categorias/editar', [
            'idiomas' => $idiomas,
            'idioma' => $idioma,
            'categoria' => $categoria
        ]);
