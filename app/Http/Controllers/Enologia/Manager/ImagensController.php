        ...
        $conteudoData = [
            ...
            'imagens' => $conteudo->imagens->map(function ($img) {
                return [
                    ...
                    'imagem' => asset('eno/content/carousel/' . $img->imagem),
                ];
            })->values()->all(),
        ];

        return Inertia::render('Enologia/Manager/Imagens/conteudo', [
    ...
    public function novo(Request $request, $id) {
        if ($request->ajax()) {
            ...
            foreach ($request->file('images') as $image) {
                ...
                if ($response) {
                    $image['img']->move(public_path('eno/content/carousel/'), $imagem->imagem);
                } else {
