...
use App\Models\Enologia\SlideIdioma;
use App\Models\Enologia\Idioma;

use Illuminate\Http\Request;
use Inertia\Inertia;
use App\Http\Requests\Enologia\Manager\PostSlideRequest;
...
class SlidesController extends Controller
{
    ...
    public function adicionar($tipo) {
        ...
        return Inertia::render('Enologia/Manager/Slides/adicionar', [
            'tipo' => $tipo
        ]);
    }
    ...
    public function editar($id) {
        ...
        if ($slide->tipo === 'imagem') {
            $slideData['imagem'] = asset('eno/content/slides/d/' . $slide->imagem);
            $slideData['imagem_mobile'] = asset('eno/content/slides/m/' . $slide->imagem_mobile);
        }
        
        return Inertia::render('Enologia/Manager/Slides/editar', [
            'idiomas' => $idiomas,
            'idioma' => $idioma,
            'slide' => $slideData
        ]);
    ...
    public function baixarVideo($id, $video) {
        ...
        if ($video == 'desktop') {
            $caminho = public_path('eno/content/slides/videos/d/' . $slide->video);
        } else if ($video == 'mobile') {
            $caminho = public_path('eno/content/slides/videos/m/' . $slide->video_mobile);
        }
