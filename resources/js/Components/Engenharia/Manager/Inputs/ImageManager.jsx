...
export default function ImageManager({ onSelectImage }) {
    ...
    const fetchImages = (folder) => {
        router.get(route('Engenharia.Manager.Images.index'), 
            { folder: folder }, 
            {
                preserveState: true,
                onSuccess: (page) => {
    ...
    const handleUpload = (e) => {
        ...
        router.post(route('Engenharia.Manager.Images.store'), formData, {
            onSuccess: (page) => {
                setImages(page.props.images);
                setUploading(false);
            },
    ...
    const createFolder = () => {
        ...
        router.post(route('Engenharia.Manager.Images.create-folder'), {
