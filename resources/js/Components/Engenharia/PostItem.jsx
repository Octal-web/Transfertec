        ...
        <section className="relative pt-10 xl:pt-20 pb-10 md:pb-24">
            <div className="container max-w-large">
                <div className="flex items-center gap-3 mb-16">
                    <span className="py-2 px-4 bg-eng-primary font-secondary text-xs text-white font-bold rounded-xl mr-2">{post.categoria}</span>
                    <CalendarIcon />
                    <span className="text-neutral-600 font-light">{post.data}</span>
                </div>

                <h2 className="text-3xl md:text-4xl 2xl:text-5xl text-eng-tertiary mb-6 mx-10 xl:mb-10">{post.titulo}</h2>
