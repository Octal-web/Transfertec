...
export const NewsBanner = ({ content, categories, onCategoryChange, selectedCategory, setSelectedCategory }) => {
    ...
    return (
        <>
            ...
            >
                <div className="absolute inset-0 bg-eng-primary mix-blend-overlay opacity-50" />
            </section>

            <section className="pt-16 pb-10">
                <div className="container max-w-large">
                    <h1 className="text-eng-primary text-4xl md:text-5xl xl:text-6xl font-light mb-8">
                        {(() => {
                            const [primeira, ...resto] = content.titulo.split(' ');
                                return (
                                    <>
                                        {primeira}{" "}
                                        <span className="text-eng-tertiary font-bold">{resto.join(' ')}</span>
                                    </>
                                );
                        })()}
                    </h1>
                    ...
                    <div className="flex items-center justify-between">
                        <h4 className="font-secondary text-2xl text-eng-tertiary">{content.subtitulo}</h4>
