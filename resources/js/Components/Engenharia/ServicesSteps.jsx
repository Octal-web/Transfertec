...
export const ServicesSteps = ({ steps }) => {
    ...
    return (
        <section 
            ref={servicesBgRef}
            className="py-16 md:py-24 min-h-screen bg-[length:auto_110%]"
            style={{
            ...
            <div className="">
                <div className="container max-w-large">
                    ...
                    <div className="relative md:mx-10">
                        <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-eng-primary transform -translate-x-1/2 hidden md:block">
                            ...
                            {steps.map((step, index) => (
                                <div 
                                    ...
                                    <div className={`absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center text-2xl md:text-3xl font-bold transition-all duration-500
                                        ${activeIndex >= index 
                                            ? 'bg-white text-eng-primary shadow-lg' 
