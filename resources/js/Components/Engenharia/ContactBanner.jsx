    ...
    return (
        <section className="relative pt-10 md:pt-16">
            <div className="relative container max-w-large">
                <h2 className="text-eng-tertiary text-5xl 2xl:text-[70px] font-bold mb-10 xl:mb-14">Fale <span className="text-eng-primary font-light">conosco</span></h2>
                
                <div className="bg-eng-primary p-8 md:px-14 md:py-10 2xl:p-14 absolute max-md:-bottom-36 max-md:translate-y-full md:top-0 max-md:left-[10%] right-[10%] md:right-[5%] md:w-1/2 max-w-md">
                    <div className="space-y-2 md:space-y-4 2xl:space-y-6">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a href="mailto:engenharia@transfertec.com.br" className="flex gap-2 items-center text-white text-sm transition-all hover:text-opacity-80" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a href="tel:+5554999544154" className="flex gap-2 items-center text-white text-sm transition-all hover:text-opacity-80" target="_blank" rel="noopener noreferrer">
                            ...
                            <ul className="flex items-center gap-4 mt-6 md:mt-8 2xl:mt-10">
                                <li>
                                    <a href="https://facebook.com/profile.php?id=61562953547369" className="flex items-center justify-center w-9 md:w-11 h-9 md:h-11 border border-white rounded-full transition-all hover:opacity-80" target="_blank" rel="noopener noreferrer">
                                        <img src={`/eng/site/img/facebook-icon.png`} alt="Phone icon" className="block" />
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="https://instagram.com/transfertec.engenharia_/" className="flex items-center justify-center w-9 md:w-11 h-9 md:h-11 border border-white rounded-full transition-all hover:opacity-80" target="_blank" rel="noopener noreferrer">
                                        <img src={`/eng/site/img/instagram-icon.png`} alt="Phone icon" className="block" />
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div
                ...
                style={{
                    backgroundImage: `url(/eng/site/img/contact-bg.jpg)`,
                }}
            />
        </section>
    );
