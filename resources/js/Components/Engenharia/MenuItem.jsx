        ...
        <li className="relative">
            {item.external ? (
                <a
                    ...
                    className="relative font-secondary block max-sm:text-xl text-white transition-opacity hover:opacity-70"
                    target="_blank"
                ...
                <div className="flex items-center">
                    <Link
                        ...
                        className={`relative font-secondary text-white transition-opacity hover:opacity-70 p-2${
                ...
                <Link
                    href={route(item.route)}
                    className={`relative font-secondary block text-white transition-opacity hover:opacity-70 p-2${
                        controller === item.controller
                            ? ` text-[0] before:content-[attr(data-before)] before:text-lg sm:before:text-base before:font-bold`
                            : ' max-sm:text-xl'
                    }`}
            ...
            {item.submenu && item.submenu.length > 0 && (
                <ul
                    ref={menuRef}
                    className={`fixed md:absolute max-md:bottom-0 max-md:-right-10 md:left-0 mt-2 w-full md:w-50 max-md:h-full max-md:flex max-md:flex-col max-md:pl-10 bg-eng-primary md:bg-white shadow-lg md:rounded-lg overflow-hidden transition-all z-[1] ${
