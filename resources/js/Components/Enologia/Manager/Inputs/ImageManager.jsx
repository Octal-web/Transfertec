...
export default function ImageManager({ onSelectImage }) {
    ...
    const fetchImages = (folder) => {
        router.get(route('Enologia.Manager.Images.index'), 
            { folder: folder }, 
            {
                preserveState: true,
                onSuccess: (page) => {
    ...
    const handleUpload = (e) => {
        ...
        router.post(route('Enologia.Manager.Images.store'), formData, {
            onSuccess: (page) => {
                setImages(page.props.images);
                setUploading(false);
            },
    ...
    const createFolder = () => {
        ...
        router.post(route('Enologia.Manager.Images.create-folder'), {
