...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 300, altura: 450 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Engenharia.Manager.Membros.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faUsers} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
