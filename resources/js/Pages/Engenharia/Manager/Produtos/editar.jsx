...
const Page = () => {
    ...
    const layoutOptions = [
        { value: '1', label: 'Fundo azul escuro' },
    ...
    const inputItems = [
        ...
        [{ titulo: 'Setor', name: 'setor', tamanho: 'col-span-12 lg:col-span-4', tipo: 'texto', max: 120 }, { titulo: 'Layout', name: 'layout', tamanho: 'col-span-12 lg:col-span-4', tipo: 'select', options: layoutOptions }],
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 800, altura: 800, imagem: produto.imagem }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Engenharia.Manager.Produtos.atualizar', {id: produto.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faFlask} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={produto.id} />
