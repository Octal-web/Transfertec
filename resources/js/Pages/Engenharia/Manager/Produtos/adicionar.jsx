...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 800, altura: 800 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Engenharia.Manager.Produtos.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faFlask} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
