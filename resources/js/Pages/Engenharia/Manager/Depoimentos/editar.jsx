...
import { faComment, faSave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const Page = () => {
    const { idioma, idiomas, depoimento } = usePage().props;

    const { data, setData, post, processing, errors } = useForm(depoimento);

    const breadcrumbItems = [
        { label: 'Home', link: 'Engenharia.Manager.Home.index' },
        { label: 'Depoimentos', link: 'Engenharia.Manager.Home.index' },
    ];

    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'texto', max: 120 }, { titulo: 'Empresa', name: 'empresa', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'texto', max: 120 }],
        [{ titulo: 'Depoimento', name: 'depoimento', tamanho: 'col-span-12 lg:col-span-8', tipo: 'texto_longo', max: 220 }],
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: false, largura: 200, altura: 200, imagem: depoimento.imagem }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Engenharia.Manager.Clientes.atualizar', {id: depoimento.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faComment} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={depoimento.id} />
