...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 200, altura: 200 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Engenharia.Manager.Depoimentos.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faComment} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
