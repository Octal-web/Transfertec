...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 900, altura: 600 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Engenharia.Manager.Etapas.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faProjectDiagram} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
