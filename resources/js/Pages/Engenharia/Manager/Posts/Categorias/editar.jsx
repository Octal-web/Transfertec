...
const Page = () => {
    ...
    const breadcrumbItems = [
        { label: 'Posts', link: 'Engenharia.Manager.News.index' },
        { label: 'Categorias', link: 'Engenharia.Manager.News.index' },
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Engenharia.Manager.Posts.Categorias.atualizar', {id: categoria.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
