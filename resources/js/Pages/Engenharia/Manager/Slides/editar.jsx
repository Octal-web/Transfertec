...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Slides', link: 'Engenharia.Manager.Home.index' },
    ];
    ...
    const inputItems = [
        ...
        ...(slide.tipo === 'video'
            ? [[
                { titulo: 'Vídeo Desktop', name: 'vid', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'video', arquivo: route('Engenharia.Manager.Slides.baixarVideo', { id: slide.id, video: 'desktop' }) },
                { titulo: 'Vídeo Mobile', name: 'vid_mobile', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'video', arquivo: route('Engenharia.Manager.Slides.baixarVideo', { id: slide.id, video: 'mobile' }) }
            ]]
            : []
        )
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Engenharia.Manager.Slides.atualizar', {id: slide.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
