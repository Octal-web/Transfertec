...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Logo', name: 'img', tamanho: 'col-span-12 lg:col-span-8 lg:col-span-8', tipo: 'imagem', crop: false, largura: 250, altura: 250 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Engenharia.Manager.Certificacoes.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faCog} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
