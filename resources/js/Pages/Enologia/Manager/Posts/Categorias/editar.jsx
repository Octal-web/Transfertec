...
const Page = () => {
    ...
    const breadcrumbItems = [
        { label: 'Posts', link: 'Enologia.Manager.News.index' },
        { label: 'Categorias', link: 'Enologia.Manager.News.index' },
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Enologia.Manager.Posts.Categorias.atualizar', {id: categoria.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
