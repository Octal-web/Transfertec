...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Subcategoria', link: 'Enologia.Manager.Equipamentos.Subcategorias.editar', params: { id: id }},
        { label: 'Produtos', link: 'Enologia.Manager.Equipamentos.Produtos.index', params: { id: id }},
    ];
    ...
    const inputItems = [
        ...
        [{ titulo: 'Catálogo', name: 'arq', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'arquivo' }, { titulo: 'Vídeo', name: 'vid', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'video' }]
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Enologia.Manager.Equipamentos.Produtos.novo', {id: id}), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faHdd} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Enologia.Manager.Equipamentos.Produtos.index', {id: id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
