...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Categorias', link: 'Enologia.Manager.Equipamentos.index' },
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Enologia.Manager.Equipamentos.Categorias.atualizar', {id: categoria.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
