...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: false, largura: 72, altura: 72 }],
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Enologia.Manager.Solucoes.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faLightbulb} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
