...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Marcas', link: 'Enologia.Manager.Insumos.index' },
    ];

    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-12 lg:col-span-4', tipo: 'texto', max: 120 }, { titulo: 'Link', name: 'link', tamanho: 'col-span-12 lg:col-span-4', tipo: 'link', max: 120 }],
        [{ titulo: 'Logo', name: 'img', tamanho: 'col-span-12 lg:col-span-4', tipo: 'imagem', crop: false, largura: 400, altura: 160, imagem: cliente.logo }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Enologia.Manager.Marcas.atualizar', {id: cliente.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
