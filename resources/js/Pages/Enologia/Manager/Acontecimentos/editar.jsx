...
const Page = () => {
    ...
    const breadcrumbItems = [
        { label: 'Institucional', link: 'Enologia.Manager.Institucional.index' },
        { label: 'Linha do Tempo', link: 'Enologia.Manager.Institucional.index' },
    ];
    ...
    const inputItems = [
        ...
        [{ titulo: 'Texto', name: 'texto', tamanho: 'col-span-12 lg:col-span-8', editor: true, 'toolbar': ['Bold', 'Italic', 'List'], tipo: 'texto_longo', max: 1500 }],
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: true, largura: 800, altura: 800, imagem: acontecimento.imagem }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Enologia.Manager.Acontecimentos.atualizar', {id: acontecimento.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Enologia.Manager.Institucional.index')} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
