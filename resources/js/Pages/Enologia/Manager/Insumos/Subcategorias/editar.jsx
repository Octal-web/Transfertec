...
import { faList, faBoxOpen, faSave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-8', tipo: 'imagem', crop: false, largura: 1200, altura: 1200, imagem: subcategoria.imagem_grafico }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Enologia.Manager.Insumos.Subcategorias.atualizar', {id: subcategoria.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-6 rounded-sm border border-stroke bg-white px-5 py-5 shadow-md">
                <Link
                    href={route('Enologia.Manager.Insumos.Produtos.index', {id: subcategoria.id})}
                ...
                >   
                    <FontAwesomeIcon icon={faBoxOpen} className="text-slate-700 mr-2" />
                    Produtos
                </Link>
