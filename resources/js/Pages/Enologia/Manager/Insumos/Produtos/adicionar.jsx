...
const Page = () => {
    const { id, idioma, marcas } = usePage().props;
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Subcategoria', link: 'Enologia.Manager.Insumos.Subcategorias.editar', params: { id: id }},
    ];

    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'texto', max: 120 }, { titulo: 'Marca', name: 'marca_id', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'select', options: marcas }],
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 lg:col-span-7', tipo: 'imagem', crop: true, largura: 1000, altura: 715 }, { titulo: 'Destaque', name: 'destaque', tamanho: 'col-span-2', tipo: 'check' }],
        [{ titulo: 'Ficha Técnica', name: 'arq_tec', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'arquivo' }, { titulo: 'Ficha de Segurança', name: 'arq_seg', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'arquivo' }]
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Enologia.Manager.Insumos.Produtos.novo', {id: id}), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faBoxOpen} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Enologia.Manager.Insumos.Produtos.index', {id: id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
