...
<head>
    ...
    <title>Obrigado pelo seu contato! | Transfertec Engenharia</title>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#012F47" data-composer>

            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <!-- lotus-header-4 -->
                <tr>
                    <td align="center"  bgcolor="#012F47" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td align="center" class="container-padding">
                                                <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ asset('eng/site/img/logo-white.png') }}" width="80" border="0" alt="Transfertec Engenharia"></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Logo & Webview -->
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:700;font-style:normal;color:#00AAE2;text-decoration:none;letter-spacing:0px;">
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div>
                                        Uma nova solicitação de orçamento foi recebida através do site com os seguintes dados:
                                    </div>
                            ...
                            <tr>
                                <td class="center-text" align="left" style="font-family:'DM Sans',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://facebook.com/profile.php?id=61562953547369"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('eng/site/img/facebook-icon.png') }}" width="26" border="0" alt="Facebook"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://instagram.com/transfertec.engenharia_/"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('eng/site/img/instagram-icon.png') }}" width="26" border="0" alt="Instagram"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div>
                                        Rua Buarque de Macedo, 2755 - Edifício Rubi Central Towers, Torre 2<br>Sala 310 - Bairro Centro, Garibaldi - RS
                                    </div>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="tel:+5554999544154" style="color:#6e6e6e;"><span>(54) 99954-4154</span></a>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:engenharia@transfertec.com.br" style="color:#6e6e6e;"><span>engenharia@transfertec.com.br</span></a>
                                            ...
                                            <td align="center">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <p style="margin:0px;padding:0px;color:#012F47;font-style:normal;font-size:11px;font-family:'Inter',Helvetica,Arial,sans-serif;font-weight:400;line-height:17px;text-decoration:none;text-transform:none;display:block;text-align:-webkit-center;text-align:center;">Você está recebendo este conteúdo, pois seu e-mail está cadastrado no site <a href="{{ url()->to('/') }}" target="_blank" style="font-weight:bold;margin:0px;border-top-width:0px;border-right-width:0px;border-left-width:0px;border-bottom-width:0px;border-style:none;border-bottom-style:none;padding:0px;float:none;color:#012F47;font-style:normal;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:11px;font-weight:bold;line-height:17px;text-transform:none;display:inline;white-space:normal;text-decoration:underline;">{{ url()->to('/') }}</a>.</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
